 ...
 * WITH THE SOFTWARE.
 *
 * File: eval.ncsu.dre.run.LiveSearchEvaluation.java
 ...
 */
public class LiveSearchEvaluation {

	static Logger logger = Logger.getLogger("eval.ncsu.dre.run.LiveSearchEvaluation");
	
	static boolean CONTENT_DIRECTION = false;
	
	public LiveSearchEvaluation()
	{
	...
	{	
		try
		{
			...
			WritableWorkbook w = Workbook.createWorkbook(new java.io.File("data/LiveSearchReport.xls"));
