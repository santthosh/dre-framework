 ...
 * WITH THE SOFTWARE.
 *
 * File: edu.ncsu.dre.exception.InternationalizedRuntimeException.java
 * Created by: santthosh
 * TimeStamp: Jul 22, 2007 + 8:30:44 PM
 */
...
public class InternationalizedRuntimeException extends RuntimeException {
	 ...
	 * <code>InternationalizedRuntimeException</code> to have a compound
	 * message, made up of multiple parts that are concatenated in a
	...
	/**
	 * Creates a new <code>InternationalizedRuntimeException</code> with a
	 * null message.
	 */
	...
	public InternationalizedRuntimeException(String aResourceBundleName,
		...
		if (mResourceBundleName == null && mMessageKey == null) {
			if (mCause instanceof InternationalizedException) {
				...
				mMessageKey = ((InternationalizedException) mCause)
						.getMessageKey();
				mArguments = ((InternationalizedException) mCause)
						.getArguments();
