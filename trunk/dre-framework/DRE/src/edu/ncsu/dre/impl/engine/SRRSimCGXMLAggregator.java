 ...
 */
public class SRRSimCGXMLAggregator implements Aggregator {
	...
	{		
		...
		{				
			...
			{
				//System.out.println(xmlResultMap.get(wordList.get(j)).toString());
	 ...
	 */
	  ...
	  {	
		  ...
		  try
		  {
			  resultStream = resultStream.replaceAll("&", "and");
