 ...
 * WITH THE SOFTWARE.
 *
 * File: test.ncsu.dre.impl.engine.DummySegregatorTest.java
...
/**
 * Test cases to test the DummySegregator class
 *
 * @author <a href="mailto:sbselvad@ncsu.edu">Santthosh Babu Selvadurai</a>
 */
public class DummySegregatorTest extends TestCase{

	DummySegregator ls = null;
	/**
	 * @throws java.lang.Exception
	 */
	@Before
	public void setUp() throws Exception {
		ls = new DummySegregator();
	}

	/**
	 * Test method for {@link edu.ncsu.dre.impl.engine.DummySegregator#segregateArtifact(java.lang.Object)}.
	 */
	@Test
	public @SuppressWarnings("unchecked") void testSegregateArtifact() {
		...
		for(int i=0;i<ObjectList.size();i++)
		{
			...
			{
				assertEquals(wordList.get(j),"Santthosh the is a Santthosh Santthosh");
			}			
		}
		...
		for(int i=0;i<ObjectList.size();i++)
		{
			ArrayList<String> wordList = (ArrayList<String>) ObjectList.get(i);
			for(int j=0;j<wordList.size();j++)
			{assertNotSame(wordList.get(j),"Santthosh the is a Santthosh Santthosh");}			
		}
		assert(false);
	}
}
